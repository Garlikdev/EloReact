...
const Footer = () => {
  return (
    <footer className='relative mt-8 sm:mt-32 bg-neutral-900 text-white w-full'>
      <svg
      ...
      <div className='mx-auto w-full py-6 lg:py-8 max-w-[80rem] px-4 sm:px-16 z-20'>
        <div className='flex items-center justify-center py-4'>
          <button className='bg-elo text-white rounded-lg shadow-highlight font-bold uppercase px-4 py-2'>
            <Link to='/formularz'>Formularz kontaktowy</Link>
          </button>
        </div>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 gap-8 sm:gap-6 md:grid-cols-4'>
            ...
            <div className='text-center sm:text-start'>
              ...
              <ul className='flex flex-col gap-2 text-sm'>
                <li>
                  <Link to='/konto' className='hover:underline'>
                    Twoje zamówienia
                  </Link>
                </li>
                <li>
                  <Link to='/konto/ustawienia' className='hover:underline'>
                    Ustawienia konta
                  </Link>
                </li>
              </ul>
